...
const switchPlayer = function () {
  ...
  currentScore = 0; // === change the current score to 0 ===

  activePlayer = activePlayer === 0 ? 1 : 0; // === Switch to next player ===

  /*
     -----
    change the style css visibility when the player active is ready to play 
    -------
    */
...
btnHold.addEventListener('click', function () {
  if (playing) {
    ...
    scores[activePlayer] += currentScore; // score[1] + currentScore
